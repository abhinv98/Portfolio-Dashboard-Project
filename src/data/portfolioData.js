  ...
  projects: {
    ...
    list: [
      ...
      },
      {
        ...
        description:
          "Developed a comprehensive e-commerce platform using ASP.NET Core and C# MVC. Integrated PayPal and Stripe payment gateways, implemented responsive design, and created an efficient admin panel for product management.",
        technologies: ["ASP.NET", "C#", "MVC", "Bootstrap"],
        date: "Sep 2023",
        type: "Personal",
        highlights: [
          "Payment integration",
